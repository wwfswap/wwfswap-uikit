...
var Logo = function (_a) {
    ...
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 600 173" }, props),
        React__default['default'].createElement("image", { width: "600", height: "173", href: isDark ? '/images/egg/LogoTextNewDark.png' : '/images/egg/LogoTextNewWhite.png' })));
};
...
var Logo$1 = function (_a) {
    ...
    return (React__default['default'].createElement(Flex, { alignItems: "center" },
        React__default['default'].createElement(MenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "24px" }, isPushed ? (React__default['default'].createElement(Icon$P, { width: "24px", color: "text" })) : (React__default['default'].createElement(Icon$O, { width: "24px", color: "text" }))),
...
var Panel = function (props) {
    var isPushed = props.isPushed, showMenu = props.showMenu, badgeLink = props.badgeLink;
    return (React__default['default'].createElement(StyledPanel, { isPushed: isPushed, showMenu: showMenu },
        React__default['default'].createElement(PanelBody, __assign({}, props)),
        badgeLink && React__default['default'].createElement(AuditButton, { auditLink: badgeLink }),
...
var Menu = function (_a) {
    var _b;
    var account = _a.account, login = _a.login, logout = _a.logout, isDark = _a.isDark, toggleTheme = _a.toggleTheme, langs = _a.langs, setLang = _a.setLang, currentLang = _a.currentLang, cakePriceUsd = _a.cakePriceUsd, links = _a.links, priceLink = _a.priceLink, badgeLink = _a.badgeLink, profile = _a.profile, children = _a.children;
    ...
    return (React__default['default'].createElement(Wrapper$1, null,
        ...
        React__default['default'].createElement(BodyWrapper, null,
            React__default['default'].createElement(Panel, { isPushed: isPushed, isMobile: isMobile, showMenu: showMenu, isDark: isDark, toggleTheme: toggleTheme, langs: langs, setLang: setLang, currentLang: currentLang, cakePriceUsd: cakePriceUsd, pushNav: setIsPushed, links: links, priceLink: priceLink, badgeLink: badgeLink }),
